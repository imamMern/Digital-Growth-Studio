                  ...
                  {custom && (
                    <div className="md:flex flex items-center md:mt-[60px] mt-[35px] md:gap-x-[10px] gap-x-[5px] relative md:w-auto w-full  ">
                      <input
                        ...
                        type="number"
                        className={`md:w-[450px] md:h-auto w-[240px] h-[40px] outline-none md:py-[12px] py-[7px] md:text-[13px] text-[10px] rounded-corner text-[#1B1C1E] placeholder:text-opacity-[0.2] ${
                      ...
                      />
                      {userInputNegative && (
                        <p className="text-[#1B1C1E] md: w-auto font-medium md:font-semibold absolute md:top-[45px] top-[35px] left-0 ">
                          {userInputNegative}
                        </p>
                      )}
